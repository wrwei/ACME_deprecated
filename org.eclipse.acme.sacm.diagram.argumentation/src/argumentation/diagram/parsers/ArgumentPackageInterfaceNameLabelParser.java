package argumentation.diagram.parsers;
 ...
 * @generated
 */
public class ArgumentPackageInterfaceNameLabelParser implements IParser {
	/**
	* @generated
	*/
	public ArgumentPackageInterfaceNameLabelParser() {
	}
	...
	*/
	private IStatus updateValues(EObject target, String newString) throws ExecutionException {
		ModelElementFeatureUtil.setName(target, newString);
	...
	*/
	private String evaluatePrintExpression(EObject self) {
		return ModelElementFeatureUtil.getName(self);
	}
