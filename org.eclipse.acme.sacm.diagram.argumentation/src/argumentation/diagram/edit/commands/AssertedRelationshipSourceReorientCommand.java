 ...
 * @generated
 */
public class AssertedRelationshipSourceReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public AssertedRelationshipSourceReorientCommand(ReorientReferenceRelationshipRequest request) {
	...
	*/
	protected boolean canReorientSource() {
		...
		return ArgumentationBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistAssertedRelationshipSource_4202(getNewSource(), getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return ArgumentationBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistAssertedRelationshipSource_4202(getOldSource(), getNewTarget());
	}
	...
	*/
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getSource().remove(getOldTarget());
		getNewSource().getSource().add(getOldTarget());
	...
	*/
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getSource().remove(getOldTarget());
		getOldSource().getSource().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
