...
public class WrappingLabel7EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ArgumentationParserProvider.getParser(ArgumentationElementTypes.ArgumentGroup_2204,
					getParserElement(), ArgumentationVisualIDRegistry
							.getType(argumentation.diagram.edit.parts.WrappingLabel7EditPart.VISUAL_ID));
		}
		return parser;
	}
