...
import argumentation.diagram.edit.policies.ArgumentationTextSelectionEditPolicy;
...
public class WrappingLabel3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public WrappingLabel3EditPart(View view) {
		super(view);
		LabelNotificationHandler.getInstance().registerName(this);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new ArgumentationTextSelectionEditPolicy());
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ArgumentationParserProvider.getParser(ArgumentationElementTypes.ArgumentPackageInterface_2202,
					getParserElement(), ArgumentationVisualIDRegistry
							.getType(argumentation.diagram.edit.parts.WrappingLabel3EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(
					new TextDirectEditManager(this, null, ArgumentationEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
