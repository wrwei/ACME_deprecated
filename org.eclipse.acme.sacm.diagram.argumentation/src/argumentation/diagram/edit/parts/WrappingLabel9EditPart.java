...
public class WrappingLabel9EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ArgumentationParserProvider.getParser(ArgumentationElementTypes.Claim_2205, getParserElement(),
					ArgumentationVisualIDRegistry
							.getType(argumentation.diagram.edit.parts.WrappingLabel9EditPart.VISUAL_ID));
		}
		return parser;
	}
