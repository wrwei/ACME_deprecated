...
public class WrappingLabel11EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ArgumentationParserProvider.getParser(ArgumentationElementTypes.ArtifactReference_2206,
					getParserElement(), ArgumentationVisualIDRegistry
							.getType(argumentation.diagram.edit.parts.WrappingLabel11EditPart.VISUAL_ID));
		}
		return parser;
	}
