...
public class WrappingLabel2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ArgumentationParserProvider.getParser(ArgumentationElementTypes.ArgumentPackage_2201,
					getParserElement(), ArgumentationVisualIDRegistry
							.getType(argumentation.diagram.edit.parts.WrappingLabel2EditPart.VISUAL_ID));
		}
		return parser;
	}
