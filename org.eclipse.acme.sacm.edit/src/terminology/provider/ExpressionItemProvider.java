...
/**
 * This is the item provider adapter for a {@link terminology.Expression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExpressionItemProvider extends ExpressionElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Expression_element_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Expression_element_feature", "_UI_Expression_type"),
				 Terminology_Package.Literals.EXPRESSION__ELEMENT,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((Expression)object).getGid();
