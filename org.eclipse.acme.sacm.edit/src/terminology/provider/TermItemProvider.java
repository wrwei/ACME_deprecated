...
/**
 * This is the item provider adapter for a {@link terminology.Term} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TermItemProvider extends ExpressionElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Term_externalReference_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Term_externalReference_feature", "_UI_Term_type"),
				 Terminology_Package.Literals.TERM__EXTERNAL_REFERENCE,
				 true,
				 false,
				 false,
	...
	protected void addOriginPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Term_origin_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Term_origin_feature", "_UI_Term_type"),
				 Terminology_Package.Literals.TERM__ORIGIN,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((Term)object).getGid();
