...
public class AssertedRelationshipItemProvider extends AssertionItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addRequiesPropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Requies feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addRequiesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AssertedRelationship_requies_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AssertedRelationship_requies_feature", "_UI_AssertedRelationship_type"),
				 Argumentation_Package.Literals.ASSERTED_RELATIONSHIP__REQUIES,
				 true,
				 false,
				 false,
