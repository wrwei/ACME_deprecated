...
/**
 * This is the item provider adapter for a {@link argumentation.ArgumentReasoning} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArgumentReasoningItemProvider extends ArgumentAssetItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ArgumentReasoning_structure_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ArgumentReasoning_structure_feature", "_UI_ArgumentReasoning_type"),
				 Argumentation_Package.Literals.ARGUMENT_REASONING__STRUCTURE,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((ArgumentReasoning)object).getGid();
