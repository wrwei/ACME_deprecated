...
/**
 * This is the item provider adapter for a {@link artifact.Event} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EventItemProvider extends ArtifactAssetItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Event_occurence_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Event_occurence_feature", "_UI_Event_type"),
				 Artifact_Package.Literals.EVENT__OCCURENCE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Event)object).getGid();
