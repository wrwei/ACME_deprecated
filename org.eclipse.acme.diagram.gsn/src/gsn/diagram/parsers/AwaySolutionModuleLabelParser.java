 ...
 * @generated
 */
public class AwaySolutionModuleLabelParser implements IParser {
	/**
	* @generated
	*/
	public AwaySolutionModuleLabelParser() {
	}
	...
	*/
	private String evaluatePrintExpression(EObject self) {
		AwaySolution awaySolution = (AwaySolution) self;
		if (!awaySolution.getReferencedArtifactElement().isEmpty()
				&& awaySolution.getReferencedArtifactElement().get(0) != null) {
			Solution solution = (Solution) awaySolution.getReferencedArtifactElement().get(0);
			String val = ModelElementFeatureUtil.getName(ModelElementUtil.getContainingModule(solution));
			return val;
		}
		return "";
	}
