 ...
 * @generated
 */
public class InContextOfLabelParser implements IParser {
	/**
	* @generated
	*/
	public InContextOfLabelParser() {
	}
	...
	*/
	private IStatus updateValues(EObject target, String newString) throws ExecutionException {
		InContextOf inContextOf = (InContextOf) target;
		inContextOf.getImplementationConstraint().get(0).getContent().getValue().get(0).setContent(newString);
	...
	*/
	private String evaluatePrintExpression(EObject self) {
		InContextOf inContextOf = (InContextOf) self;
		return inContextOf.getImplementationConstraint().get(0).getContent().getValue().get(0).getContent();
	}
