 ...
 * @generated
 */
public class AwaySolutionDescriptionLabelParser implements IParser {
	/**
	* @generated
	*/
	public AwaySolutionDescriptionLabelParser() {
	}
	...
	*/
	private String evaluatePrintExpression(EObject self) {
		...
		if (solution != null) {
			String val = ModelElementFeatureUtil.getDescription(solution);
			return val;
		}
		return "<...>";
	}
