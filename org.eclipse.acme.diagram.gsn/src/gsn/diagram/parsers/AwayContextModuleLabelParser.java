 ...
 * @generated
 */
public class AwayContextModuleLabelParser implements IParser {
	/**
	* @generated
	*/
	public AwayContextModuleLabelParser() {
	}
	...
	*/
	private String evaluatePrintExpression(EObject self) {
		AwayContext awayContext = (AwayContext) self;
		if (awayContext.getCitedElement() != null) {
			Context context = (Context) awayContext.getCitedElement();
			String val = ModelElementFeatureUtil.getName(ModelElementUtil.getContainingModule(context));
			return val;
		}
		return "";
	}
