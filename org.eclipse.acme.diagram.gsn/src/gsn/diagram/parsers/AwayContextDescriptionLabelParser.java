 ...
 * @generated
 */
public class AwayContextDescriptionLabelParser implements IParser {
	/**
	* @generated
	*/
	public AwayContextDescriptionLabelParser() {
	}
	...
	*/
	private String evaluatePrintExpression(EObject self) {
		...
		if (context != null) {
			String val = ModelElementFeatureUtil.getDescription(context);
			return val;
		}
		return "<...>";
	}
