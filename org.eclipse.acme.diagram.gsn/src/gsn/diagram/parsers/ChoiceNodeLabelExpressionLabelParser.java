 ...
 * @generated
 */
public class ChoiceNodeLabelExpressionLabelParser implements IParser {
	/**
	* @generated
	*/
	public ChoiceNodeLabelExpressionLabelParser() {
	}
	...
	*/
	private IStatus updateValues(EObject target, String newString) throws ExecutionException {
		...
		choiceNode.getImplementationConstraint().get(0).getContent().getValue().get(0).setContent(newString);
	...
	*/
	private String evaluatePrintExpression(EObject self) {
		ChoiceNode choiceNode = (ChoiceNode) self;
		return choiceNode.getImplementationConstraint().get(0).getContent().getValue().get(0).getContent();
	}
