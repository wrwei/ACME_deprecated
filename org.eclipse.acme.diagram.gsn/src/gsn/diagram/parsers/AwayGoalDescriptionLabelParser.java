 ...
 * @generated
 */
public class AwayGoalDescriptionLabelParser implements IParser {
	/**
	* @generated
	*/
	public AwayGoalDescriptionLabelParser() {
	}
	...
	*/
	private String evaluatePrintExpression(EObject self) {
		...
		if (goal != null) {
			String val = ModelElementFeatureUtil.getDescription(goal);
			return val;
		}
		return "<...>";
	}
