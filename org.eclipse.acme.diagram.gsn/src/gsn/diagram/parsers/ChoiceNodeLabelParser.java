 ...
 * @generated
 */
public class ChoiceNodeLabelParser implements IParser {
	/**
	* @generated
	*/
	public ChoiceNodeLabelParser() {
	}
	...
	*/
	private String evaluatePrintExpression(EObject self) {
		...
		return choiceNode.getDescription().getContent().getValue().get(0).getContent();
	}
