 ...
 * @generated
 */
public class AwayGoalModuleLabelParser implements IParser {
	/**
	* @generated
	*/
	public AwayGoalModuleLabelParser() {
	}
	...
	*/
	private String evaluatePrintExpression(EObject self) {
		AwayGoal awayGoal = (AwayGoal) self;
		if (awayGoal.getCitedElement() != null) {
			Goal goal = (Goal) awayGoal.getCitedElement();
			String val = ModelElementFeatureUtil.getName(ModelElementUtil.getContainingModule(goal));
			return val;
		}
		return "";
	}
