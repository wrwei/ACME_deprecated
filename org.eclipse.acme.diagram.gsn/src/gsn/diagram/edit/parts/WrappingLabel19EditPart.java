...
import gsn.diagram.edit.policies.GsnTextSelectionEditPolicy;
 ...
 * @generated
 */
public class WrappingLabel19EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(GsnVisualIDRegistry.getType(gsn.diagram.edit.parts.WrappingLabel19EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new GsnTextSelectionEditPolicy());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GsnParserProvider.getParser(GsnElementTypes.ChoiceNode_2310, getParserElement(),
					GsnVisualIDRegistry.getType(gsn.diagram.edit.parts.WrappingLabel19EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, GsnEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
