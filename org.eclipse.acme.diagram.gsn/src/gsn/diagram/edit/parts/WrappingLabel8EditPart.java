...
public class WrappingLabel8EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GsnParserProvider.getParser(GsnElementTypes.Strategy_2304, getParserElement(),
					GsnVisualIDRegistry.getType(gsn.diagram.edit.parts.WrappingLabel8EditPart.VISUAL_ID));
		}
		return parser;
	}
