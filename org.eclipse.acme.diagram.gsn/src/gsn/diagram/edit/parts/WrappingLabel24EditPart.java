...
public class WrappingLabel24EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public WrappingLabel24EditPart(View view) {
		super(view);
		LabelNotificationHandler.getInstance().registerModuleDescriptors(this);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GsnParserProvider.getParser(GsnElementTypes.AwayGoal_2312, getParserElement(),
					GsnVisualIDRegistry.getType(gsn.diagram.edit.parts.WrappingLabel24EditPart.VISUAL_ID));
		}
		return parser;
	}
