 ...
 * @generated
 */
public class WrappingLabel31EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(GsnVisualIDRegistry.getType(gsn.diagram.edit.parts.WrappingLabel31EditPart.VISUAL_ID),
				new Point(20, 0));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GsnParserProvider.getParser(GsnElementTypes.SupportedBy_4401, getParserElement(),
					GsnVisualIDRegistry.getType(gsn.diagram.edit.parts.WrappingLabel31EditPart.VISUAL_ID));
		}
		return parser;
	}
