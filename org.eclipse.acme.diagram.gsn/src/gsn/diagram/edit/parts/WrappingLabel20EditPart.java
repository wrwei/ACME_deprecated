...
public class WrappingLabel20EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GsnParserProvider.getParser(GsnElementTypes.ContractModuleReference_2311, getParserElement(),
					GsnVisualIDRegistry.getType(gsn.diagram.edit.parts.WrappingLabel20EditPart.VISUAL_ID));
		}
		return parser;
	}
