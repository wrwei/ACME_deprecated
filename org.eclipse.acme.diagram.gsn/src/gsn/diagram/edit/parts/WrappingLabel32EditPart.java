 ...
 * @generated
 */
public class WrappingLabel32EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(GsnVisualIDRegistry.getType(gsn.diagram.edit.parts.WrappingLabel32EditPart.VISUAL_ID),
				new Point(0, 20));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GsnParserProvider.getParser(GsnElementTypes.InContextOf_4402, getParserElement(),
					GsnVisualIDRegistry.getType(gsn.diagram.edit.parts.WrappingLabel32EditPart.VISUAL_ID));
		}
		return parser;
	}
