 ...
 * @generated
 */
public class SupportedByCreateCommand extends EditElementCommand {
	...
	* @generated
	*/
	public SupportedByCreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
	...
	*/
	public boolean canExecute() {
		...
		return GsnBaseItemSemanticEditPolicy.getLinkConstraints().canCreateSupportedBy_4401(getContainer(), getSource(),
				getTarget());
	}
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		SupportedBy newElement = Gsn_Factory.eINSTANCE.createSupportedBy();
	...
	* @generated
	*/
	protected void doConfigure(SupportedBy newElement, IProgressMonitor monitor, IAdaptable info)
