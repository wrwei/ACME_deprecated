 ...
 * @generated
 */
public class ArtifactPackageInterfaceNameLabelParser implements IParser {
	/**
	* @generated
	*/
	public ArtifactPackageInterfaceNameLabelParser() {
	}
	...
	*/
	private IStatus updateValues(EObject target, String newString) throws ExecutionException {
		...
		return new Status(IStatus.OK, "acme.artifact.diagram", "OK");
	}
