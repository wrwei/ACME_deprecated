...
public class WrappingLabel22EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ArtifactParserProvider.getParser(ArtifactElementTypes.ArtifactGroup_2111, getParserElement(),
					ArtifactVisualIDRegistry.getType(artifact.diagram.edit.parts.WrappingLabel22EditPart.VISUAL_ID));
		}
		return parser;
	}
