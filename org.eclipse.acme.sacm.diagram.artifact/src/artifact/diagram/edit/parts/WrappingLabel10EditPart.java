...
public class WrappingLabel10EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ArtifactParserProvider.getParser(ArtifactElementTypes.Activity_2105, getParserElement(),
					ArtifactVisualIDRegistry.getType(artifact.diagram.edit.parts.WrappingLabel10EditPart.VISUAL_ID));
		}
		return parser;
	}
