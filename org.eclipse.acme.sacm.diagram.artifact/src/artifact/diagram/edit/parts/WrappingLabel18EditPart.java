...
public class WrappingLabel18EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ArtifactParserProvider.getParser(ArtifactElementTypes.Property_2109, getParserElement(),
					ArtifactVisualIDRegistry.getType(artifact.diagram.edit.parts.WrappingLabel18EditPart.VISUAL_ID));
		}
		return parser;
	}
