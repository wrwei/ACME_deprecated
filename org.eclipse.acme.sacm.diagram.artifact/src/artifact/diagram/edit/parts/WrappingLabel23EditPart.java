...
public class WrappingLabel23EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				ArtifactVisualIDRegistry.getType(artifact.diagram.edit.parts.WrappingLabel23EditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ArtifactParserProvider.getParser(ArtifactElementTypes.ArtifactAssetRelationship_4101,
					getParserElement(),
					ArtifactVisualIDRegistry.getType(artifact.diagram.edit.parts.WrappingLabel23EditPart.VISUAL_ID));
		}
		return parser;
