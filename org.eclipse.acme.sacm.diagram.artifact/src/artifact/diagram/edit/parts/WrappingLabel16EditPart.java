...
public class WrappingLabel16EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ArtifactParserProvider.getParser(ArtifactElementTypes.Resource_2108, getParserElement(),
					ArtifactVisualIDRegistry.getType(artifact.diagram.edit.parts.WrappingLabel16EditPart.VISUAL_ID));
		}
		return parser;
	}
