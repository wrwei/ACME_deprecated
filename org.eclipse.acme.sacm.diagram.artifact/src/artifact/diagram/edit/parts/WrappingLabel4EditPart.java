...
public class WrappingLabel4EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ArtifactParserProvider.getParser(ArtifactElementTypes.ArtifactPackageInterface_2102,
					getParserElement(),
					ArtifactVisualIDRegistry.getType(artifact.diagram.edit.parts.WrappingLabel4EditPart.VISUAL_ID));
		}
		return parser;
	}
