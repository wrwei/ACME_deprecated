...
public class SupportedByPipeConnection extends PolylineConnection {
	...
	protected void outlineShape(Graphics g) {
		...
		if (supportedBy != null) {
			...
			if (supportedBy.isIsMany()) {
				...
				switch (lineup) {
				case 1:
					g.drawText(constraint, midPoint.x + 20, midPoint.y - 20);

					break;
				case 2:
					g.drawText(constraint, midPoint.x + 20, midPoint.y);
