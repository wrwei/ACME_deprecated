	...
	public IParser getParser() {
		if (parser == null) {
			parser = assuranceCase.diagram.providers.AssurancecaseParserProvider.getParser(
					assuranceCase.diagram.providers.AssurancecaseElementTypes.CAEModuleBinding_2017, getParserElement(),
					assuranceCase.diagram.part.AssurancecaseVisualIDRegistry
							.getType(assuranceCase.diagram.edit.parts.WrappingLabel34EditPart.VISUAL_ID));
		}
		return parser;
	}
