	...
	public IParser getParser() {
		if (parser == null) {
			parser = assuranceCase.diagram.providers.AssurancecaseParserProvider.getParser(
					assuranceCase.diagram.providers.AssurancecaseElementTypes.ArgumentPackage_2004, getParserElement(),
					assuranceCase.diagram.part.AssurancecaseVisualIDRegistry
							.getType(assuranceCase.diagram.edit.parts.WrappingLabel8EditPart.VISUAL_ID));
		}
		return parser;
	}
