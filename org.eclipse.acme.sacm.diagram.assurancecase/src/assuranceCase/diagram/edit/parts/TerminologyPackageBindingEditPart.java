	...
	*/
	...
	public class TerminologyPackageBindingFigure extends TerminologyPackageBindingShape {
		...
		private void createContents() {
			...
			this.add(fFigureTpbName, new Rectangle(5, TerminologyPackageBindingShape.TOP_RECT_HEIGHT + 5,
			...
			this.add(fFigureTpbDescription, new Rectangle(5, TerminologyPackageBindingShape.TOP_RECT_HEIGHT + 35,
