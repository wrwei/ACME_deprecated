...
public class WrappingLabel14EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public WrappingLabel14EditPart(View view) {
		super(view);
		LabelNotificationHandler.getInstance().registerDescription(this);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new assuranceCase.diagram.edit.policies.AssurancecaseTextSelectionEditPolicy());
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = assuranceCase.diagram.providers.AssurancecaseParserProvider.getParser(
					assuranceCase.diagram.providers.AssurancecaseElementTypes.ArtifactPackage_2007, getParserElement(),
					assuranceCase.diagram.part.AssurancecaseVisualIDRegistry
							.getType(assuranceCase.diagram.edit.parts.WrappingLabel14EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					assuranceCase.diagram.edit.parts.AssurancecaseEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
