	...
	public IParser getParser() {
		if (parser == null) {
			parser = assuranceCase.diagram.providers.AssurancecaseParserProvider.getParser(
					assuranceCase.diagram.providers.AssurancecaseElementTypes.ContractModule_2014, getParserElement(),
					assuranceCase.diagram.part.AssurancecaseVisualIDRegistry
							.getType(assuranceCase.diagram.edit.parts.WrappingLabel28EditPart.VISUAL_ID));
		}
		return parser;
	}
