	...
	public IParser getParser() {
		if (parser == null) {
			parser = assuranceCase.diagram.providers.AssurancecaseParserProvider.getParser(
					assuranceCase.diagram.providers.AssurancecaseElementTypes.CAEModule_2015, getParserElement(),
					assuranceCase.diagram.part.AssurancecaseVisualIDRegistry
							.getType(assuranceCase.diagram.edit.parts.WrappingLabel30EditPart.VISUAL_ID));
		}
		return parser;
	}
