	...
	*/
	...
	public class AssuranceCasePackageFigure extends AssuranceCasePackageShape {
		...
		private void createContents() {
			...
			this.add(fFigureAcpName, new Rectangle(5, AssuranceCasePackageShape.TOP_RECT_HEIGHT + 5,
			...
			Dimension descrioDimension = DimensionUtil.getTextSize(fFigureAcpDescription.getText(),
					fFigureAcpDescription.getFont(), DimensionUtil.ASSURANCE_PACKAGE_DIMENSION.width - 10);

			this.add(fFigureAcpDescription, new Rectangle(5, AssuranceCasePackageShape.TOP_RECT_HEIGHT + 35,
