	...
	*/
	...
	public class TerminologyPackageFigure extends TerminologyPackageShape {
		...
		private void createContents() {
			...
			this.add(fFigureTpName, new Rectangle(5, TerminologyPackageShape.TOP_RECT_HEIGHT + 5, nameDimension.width,
			...
			this.add(fFigureTpDescription, new Rectangle(5, TerminologyPackageShape.TOP_RECT_HEIGHT + 35,
