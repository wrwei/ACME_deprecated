...
public class OpenAssurancecaseDiagramCommand extends AbstractTransactionalCommand {
	...
	* @generated
	*/
	public OpenAssurancecaseDiagramCommand(HintedDiagramLinkStyle linkStyle) {
	...
	*/
	protected String getEditorID() {
		return "assuranceCase.diagram.part.AssurancecaseDiagramEditorID";
	}
}
