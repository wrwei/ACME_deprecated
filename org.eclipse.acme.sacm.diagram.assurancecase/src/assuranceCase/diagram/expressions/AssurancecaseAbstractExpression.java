 ...
 * @generated
 */
public abstract class AssurancecaseAbstractExpression {
	...
	*/
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = assuranceCase.diagram.part.AssurancecaseDiagramEditorPlugin.ID;
	...
	* @generated
	*/
	protected AssurancecaseAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
