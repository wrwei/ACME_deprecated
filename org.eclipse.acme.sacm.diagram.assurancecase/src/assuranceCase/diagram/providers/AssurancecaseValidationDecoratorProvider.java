 ...
 * @generated
 */
public class AssurancecaseValidationDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
	...
	* @generated
	*/
	private static final String MARKER_TYPE = assuranceCase.diagram.part.AssurancecaseDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart || editPart instanceof AbstractConnectionEditPart) {
			...
			if (((DiagramEditDomain) ed)
					.getEditorPart() instanceof assuranceCase.diagram.part.AssurancecaseDiagramEditor) {
	...
	*/
	public boolean provides(IOperation operation) {
		...
		return view != null && assuranceCase.diagram.edit.parts.AssuranceCasePackageCanvasEditPart.MODEL_ID
