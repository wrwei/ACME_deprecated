 ...
 * @generated
 */
public class AssurancecaseMarkerNavigationProvider extends AbstractModelMarkerNavigationProvider {

	/**
	* @generated
	*/
	public static final String MARKER_TYPE = assuranceCase.diagram.part.AssurancecaseDiagramEditorPlugin.ID
	...
	*/
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			assuranceCase.diagram.part.AssurancecaseDiagramEditorUtil.selectElementsInDiagram(editor,
