 ...
 * </p>
 * <ul>
 *   <li>{@link gsn.impl.SolutionImpl#isIsPublic <em>Is Public</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SolutionImpl extends ArtifactReferenceImpl implements Solution {
	/**
	...
	protected EClass eStaticClass() {
		return Gsn_Package.Literals.SOLUTION;
	}
	...
	public void setIsPublic(boolean newIsPublic) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gsn_Package.SOLUTION__IS_PUBLIC, oldIsPublic, isPublic));
	}
