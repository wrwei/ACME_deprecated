...
import argumentation.impl.AssertedInferenceImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link gsn.impl.SupportedByImpl#isIsMany <em>Is Many</em>}</li>
 *   <li>{@link gsn.impl.SupportedByImpl#isIsOptional <em>Is Optional</em>}</li>
 *   <li>{@link gsn.impl.SupportedByImpl#isIsChoice <em>Is Choice</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SupportedByImpl extends AssertedInferenceImpl implements SupportedBy {
	/**
	...
	protected EClass eStaticClass() {
		return Gsn_Package.Literals.SUPPORTED_BY;
	}
	...
	public void setIsMany(boolean newIsMany) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gsn_Package.SUPPORTED_BY__IS_MANY, oldIsMany, isMany));
	}
	...
	public void setIsOptional(boolean newIsOptional) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gsn_Package.SUPPORTED_BY__IS_OPTIONAL, oldIsOptional, isOptional));
	}
	...
	public void setIsChoice(boolean newIsChoice) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gsn_Package.SUPPORTED_BY__IS_CHOICE, oldIsChoice, isChoice));
	}
