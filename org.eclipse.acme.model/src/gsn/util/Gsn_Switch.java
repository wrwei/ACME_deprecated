...
public class Gsn_Switch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case Gsn_Package.CHOICE_NODE: {
				ChoiceNode choiceNode = (ChoiceNode)theEObject;
				T result = caseChoiceNode(choiceNode);
				if (result == null) result = caseArgumentAsset(choiceNode);
				if (result == null) result = caseArgumentationElement(choiceNode);
				if (result == null) result = caseArtifactElement(choiceNode);
				if (result == null) result = caseModelElement(choiceNode);
				if (result == null) result = caseSACMElement(choiceNode);
				if (result == null) result = caseElement(choiceNode);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
