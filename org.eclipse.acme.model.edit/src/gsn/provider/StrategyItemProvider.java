...
/**
 * This is the item provider adapter for a {@link gsn.Strategy} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StrategyItemProvider extends ArgumentReasoningItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Strategy_undeveloped_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Strategy_undeveloped_feature", "_UI_Strategy_type"),
				 Gsn_Package.Literals.STRATEGY__UNDEVELOPED,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Strategy)object).getGid();
