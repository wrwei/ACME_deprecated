...
/**
 * This is the item provider adapter for a {@link gsn.Solution} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SolutionItemProvider extends ArtifactReferenceItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Solution_isPublic_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Solution_isPublic_feature", "_UI_Solution_type"),
				 Gsn_Package.Literals.SOLUTION__IS_PUBLIC,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Solution)object).getGid();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Solution.class)) {
			case Gsn_Package.SOLUTION__IS_PUBLIC:
